                    ...
                    n = function() {
                        if (r.is(":visible")) {
                            var e = t.scrollLeft(),
                                ...
                                h = r.width(),
                                u = t.width();
                            i + s + f >= a && i <= a + l + f && c + h + o >= e && c <= e + u + o ? r.appeared || r.trigger("appear", p.data) : r.appeared = !1
                        } else r.appeared = !1
                    },
                    c = function() {
        ...
        e.timelineEl.classList.add("timeline--horizontal"), t = e, window.innerWidth > t.forceVerticalMode && (t.itemWidth = t.wrap.offsetWidth / t.visibleItems, t.items.forEach(function(e) {
            ...
            function(e) {
                ...
                e.addEventListener("click", function(e) {
                    e.preventDefault(), 0 === (c = this.classList.contains("timeline-nav-button--next") ? c += 1 : c -= 1) ? (r.disabled = !0, s.disabled = !1) : c === a ? (r.disabled = !1, s.disabled = !0) : (r.disabled = !1, s.disabled = !1), m(i)
                })
            })
    }
    ...
    function o() {
        f.forEach(function(e) {
            e.timelineEl.style.opacity = 0, e.timelineEl.classList.contains("timeline--loaded") || e.items.forEach(function(e) {
                    i(e.querySelector(".timeline-content"), document.createElement("div"), "timeline-content__wrap"), i(e.querySelector(".timeline-content__wrap"), document.createElement("div"), "timeline-item__inner")
                }),
                function(e) {
                    c = 0, e.timelineEl.classList.remove("timeline--horizontal", "timeline--mobile"), e.scroller.removeAttribute("style"), e.items.forEach(function(e) {
                        e.removeAttribute("style"), e.classList.remove("animated", "fadeIn", "timeline-item--left", "timeline-item--right")
                    });
                    ...
                    i.items.forEach(function(e, t) {
                        e.classList.remove("animated", "fadeIn"), !l(e) && 0 < t ? e.classList.add("animated") : n = t, t % 2 == ("left" === i.verticalStartPosition ? 1 : 0) && window.innerWidth > v.forceVerticalMode ? e.classList.add("timeline-item--right") : e.classList.add("timeline-item--left")
                    });
